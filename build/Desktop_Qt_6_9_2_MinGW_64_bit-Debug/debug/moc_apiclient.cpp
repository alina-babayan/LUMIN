...
template <> constexpr inline auto ApiClient::qt_create_metaobjectdata<qt_meta_tag_ZN9ApiClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'response'
        QtMocHelpers::SignalData<void(const QJsonDocument &, bool, const QString &, const QString &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QJsonDocument, 3 }, { QMetaType::Bool, 4 }, { QMetaType::QString, 5 }, { QMetaType::QString, 6 },
        }}),
    };
...
void ApiClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->response((*reinterpret_cast< std::add_pointer_t<QJsonDocument>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[4]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ApiClient::*)(const QJsonDocument & , bool , const QString & , const QString & )>(_a, &ApiClient::response, 0))
            return;
    }
}
...
// SIGNAL 0
void ApiClient::response(const QJsonDocument & _t1, bool _t2, const QString & _t3, const QString & _t4)
{
